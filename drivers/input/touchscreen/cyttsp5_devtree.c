 ...
 */
	value = of_get_named_gpio(core_node, "cy,irq-gpio", 0);
 ...
 */
	value = of_get_named_gpio(core_node, "cy,rst-gpio", 0);
	pr_info("%s: cyttsp5: rst value = %d\n",__func__,value);
	pdata->rst_gpio = value;

	value = of_get_named_gpio(core_node, "cy,panelid-gpio", 0);
	pr_info("%s: cyttsp5: panelid value = %d\n",__func__,value);
	pdata->panelid_gpio = value;
