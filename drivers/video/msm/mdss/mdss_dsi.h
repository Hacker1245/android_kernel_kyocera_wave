...
struct dsi_pinctrl_res {
	...
	struct pinctrl_state *gpio_state_det_active1;
	struct pinctrl_state *gpio_state_det_active2;
	struct pinctrl_state *gpio_state_id0_active1;
	struct pinctrl_state *gpio_state_id0_active2;
	struct pinctrl_state *gpio_state_id1_active1;
	struct pinctrl_state *gpio_state_id1_active2;
};
...
struct mdss_dsi_ctrl_pdata {
	...
	struct dsi_panel_cmds no_otp_cmds;
	struct dsi_panel_cmds on2_cmds;
