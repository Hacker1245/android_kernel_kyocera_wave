...
/* Temporary solution */
show_one(scaling_max_limit, limit);
/* Temporary solution */
...
{									\
	...
	new_policy.limit = new_policy.user_policy.limit;		\
									\
	...
	policy->user_policy.limit = new_policy.limit;			\
									\
...
/* Temporary solution */
store_one(scaling_max_limit, limit);
/* Temporary solution */
...
/* Temporary solution */
cpufreq_freq_attr_rw(scaling_max_limit);
/* Temporary solution */
			     ...
			     bool frozen)
{
	...
	/* Temporary solution */
	policy->user_policy.limit = policy->limit;
	/* Temporary solution */
	...
	/* Temporary solution */
	if (per_cpu(cpufreq_policy_save, cpu).limit) {
		policy->limit = per_cpu(cpufreq_policy_save, cpu).limit;
		policy->user_policy.limit = policy->limit;
	}
	/* Temporary solution */
...
int cpufreq_update_policy(unsigned int cpu)
{
	...
	/* Temporary solution */
	new_policy.limit = policy->user_policy.limit;
	/* Temporary solution */
	/*
