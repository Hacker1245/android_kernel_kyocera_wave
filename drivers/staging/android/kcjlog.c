...
static void set_kcj_fixed_info(void)
{
	...
	memcpy( &pPanicInfo->kcj_info.kcd.linux_banner[0], &linux_banner[0], banner_len );
...
void set_kcj_fixed_info_modem(void)
{
	...
	memcpy( &pPanicInfo->kcj_info.kcd.product_number[0], &pSmemLogInfo->kcj_info.kcd.product_number[0], PRODUCT_SIZE );
	memcpy( &pPanicInfo->kcj_info.kcd.baseband_version[0], &pSmemLogInfo->kcj_info.kcd.baseband_version[0], BASEBAND_VERSION_SIZE );
	memcpy( &pPanicInfo->kcj_info.kcd.modem_build_date[0], &pSmemLogInfo->kcj_info.kcd.modem_build_date[0], BUILD_DATE_SIZE );
}
...
static void resetlog_to_eMMC_kyocera_write( void )
{
    ...
    memcpy( &Emmc_log_info.rec_info[write_index].kcj_info.kcd.linux_banner[0]       , pLogInfo->kcj_info.kcd.linux_banner       , BANNER_SIZE );
    memcpy( &Emmc_log_info.rec_info[write_index].kcj_info.kcd.product_number[0]     , pLogInfo->kcj_info.kcd.product_number     , PRODUCT_SIZE );
    memcpy( &Emmc_log_info.rec_info[write_index].kcj_info.kcd.software_version[0]   , pLogInfo->kcj_info.kcd.software_version   , SOFT_VERSION_SIZE );
    memcpy( &Emmc_log_info.rec_info[write_index].kcj_info.kcd.baseband_version[0]   , pLogInfo->kcj_info.kcd.baseband_version   , BASEBAND_VERSION_SIZE );
    memcpy( &Emmc_log_info.rec_info[write_index].kcj_info.kcd.android_build_date[0] , pLogInfo->kcj_info.kcd.android_build_date , BUILD_DATE_SIZE );
    memcpy( &Emmc_log_info.rec_info[write_index].kcj_info.kcd.modem_build_date[0]   , pLogInfo->kcj_info.kcd.modem_build_date   , BUILD_DATE_SIZE );
