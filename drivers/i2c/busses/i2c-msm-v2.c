...
#define GPIO_I2C_PRIM_SDA    22
#define GPIO_I2C_PRIM_SCL    23
#define GPIO_NUM_OFFSET     902

#define MSM_8916_BLSP1_QUP2_I2C_BUS_ID   0
#define MSM_8916_BLSP1_QUP4_I2C_BUS_ID   4
#define MSM_8916_BLSP1_QUP5_I2C_BUS_ID   5
#define MSM_8916_BLSP1_QUP6_I2C_BUS_ID   6
...
i2c_msm_compulsory_reset(struct i2c_adapter *adap, bool init_flg)
{
	...
	if(((adap->nr) == MSM_8916_BLSP1_QUP2_I2C_BUS_ID) ||
	   ((adap->nr) == MSM_8916_BLSP1_QUP4_I2C_BUS_ID) ||
	   ((adap->nr) == MSM_8916_BLSP1_QUP6_I2C_BUS_ID)){
		
		switch(adap->nr) {
			case MSM_8916_BLSP1_QUP2_I2C_BUS_ID:
				scl = GPIO_I2C_SECO_SCL + GPIO_NUM_OFFSET;
				sda = GPIO_I2C_SECO_SDA + GPIO_NUM_OFFSET;
				break;
			case MSM_8916_BLSP1_QUP4_I2C_BUS_ID:
				scl = GPIO_I2C_SMB_SCL + GPIO_NUM_OFFSET;
				sda = GPIO_I2C_SMB_SDA + GPIO_NUM_OFFSET;
				break;
			case MSM_8916_BLSP1_QUP6_I2C_BUS_ID:
