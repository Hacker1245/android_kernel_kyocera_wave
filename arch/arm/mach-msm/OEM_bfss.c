...
#endif
static unsigned int oem_bfss_open_counter;
/*----------------------------------------------------------------------------*/
/*                            read                                            */
/*----------------------------------------------------------------------------*/
...
#endif
	printk(OEM_BFSS_LOG_04 "[%04d]:%s() end.  count = %d\n", __LINE__, __func__, count);
	return 0;
}
/*----------------------------------------------------------------------------*/
/*                            write                                           */
...
/*                            ioctl                                           */
/*----------------------------------------------------------------------------*/
static long OEM_bfss_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
	int rc = 0;

	printk(OEM_BFSS_LOG_06 "[%04d]:%s() start.  cmd = 0x%08X\n", __LINE__, __func__, cmd);
	...
	printk(OEM_BFSS_LOG_03 "[%04d]:%s() end.  rc = %d\n", __LINE__, __func__, rc);
